...
import { Heading, Box, Flex, Avatar, Button, Link, Text, Separator } from '@radix-ui/themes';
...
export default function () {
    ...
    return <div className="bg-gradient-to-r from-black to-gray-800 h-screen">
        ...
        <div className='pt-20'>
            <Box width="50%" className='mx-auto px-4'>
                <div className="container flex flex-col items-center justify-center py-5 md:flex-row">
                    <div className="flex justify-center mx-5">
                        <img className="object-cover rounded-full" src={session ? session.user.image : null} alt="" />
                    </div>

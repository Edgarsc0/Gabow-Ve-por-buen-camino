'use client';
import { Button, Tabs, Box, Text, Heading, Separator, Card, Inset, Strong, Grid, Badge } from '@radix-ui/themes';
                    ...
                    <Tabs.Content value='account'>
                        ...
                        <Slide>
                            <Box width="90%" className='mx-auto px-4'>
                                        ...
                                        <Grid columns="2" gap="8" mt="8" className='xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3"'>
                                            <Fade cascade>
                                                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                    ...
                                                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Navegación en Interiores</h1>
                                                ...
                                                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                    ...
                                                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Busqueda de destinos</h1>
                                                ...
                                                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                    ...
                                                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Navegación paso por paso</h1>
                                                ...
                                                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                    ...
                                                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Gabow Inside View</h1>
                                ...
                                <section>
                                    <Box class="container py-3 mx-auto">
                                        <Box >
                                            <Heading weight="medium" mb="3" mt="5">
                                                ¿Perdido?
                                            </Heading>
                                            ...
                                            <Zoom>
                                                <Box>
                                                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                        ...
                                                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">¡Usalo en el aeropuerto!</h1>
                                            ...
                                            <Zoom>
                                                <Box>
                                                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                        ...
                                                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">¡Usalo en tu escuela!</h1>
                                            ...
                                            <Zoom>
                                                <Box>
                                                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                        ...
                                                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">¡Usalo en el parque!</h1>
                                            ...
                                            <Zoom>
                                                <Box>
                                                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                                        ...
                                                        <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">¡Usalo en plazas comerciales!</h1>
